...
Status: **Phases 0–2 implemented** (streaming MVP; §0.1's Go/No-Go gate
was explicitly overridden by the repo owner to proceed — see below).
Phases 3+ (full sampling/config, tool calling, model management, TUI, GPU
