...
mod tests {
    ...
    fn test_validate_path_within_working_directory() {
        ...
        let plan_file = working_dir.join(format!(".crustly_plan_{}.json", session_id));
    ...
    fn test_validate_path_outside_working_directory() {
        ...
        let plan_file = PathBuf::from("/tmp").join(format!(".crustly_plan_{}.json", session_id));
    ...
    fn test_validate_path_traversal_attack() {
        ...
        let plan_file = parent.join(format!(".crustly_plan_{}.json", session_id));
    ...
    fn test_validate_filename_requires_uuid() {
        ...
        let plan_file = working_dir.join(".crustly_plan_not-a-uuid.json");
    ...
    fn test_filename_with_special_characters() {
        ...
        let plan_file = working_dir.join(".crustly_plan_../../etc/passwd.json");
    ...
    fn test_filename_with_null_byte() {
        ...
        let session_id = uuid::Uuid::new_v4();
        let filename = format!(".crustly_plan_{}\0.json", session_id);
